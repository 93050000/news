...
<div >
    ...
    <!-- <img src="../assets/img/1212.png" class="index-bg"> -->
    <div class="container">
      <div class="news-list">
        <div class="news-list-left">
          <div class="news-list-item" id="join" >
        ...
        <div class="news-list-right">
          <div class="about">
            <h4>关于我们</h4>
            <div class="about-des">
              <p>本系统使用了Spring+MyBatis+SpringMVC+
                Vue等多项技术开发,灵活运用SSM框架结合Vue,形成前后分离的前后台系统,
                总系统在JavaWeb的基础上以及框架的支持实现了新闻管理,用户管理,栏目管理等的
                CRUD功能
                <br>
                <br>
                <br>
        ...
        <footer class="copyright">
          JoinUs &nbsp; 2021 DreamBoy All rights reserved.
        </footer>
      </div>
    </div>
    ...
    */
    ...
    function updataPoint(event) {
     let targetIndex = 0;
      ...
      $.ajax({
          url: "http://localhost:8085/SSM_4034/qian/guest/guestlist",
          json: "json",
          type: "get",
          success: function (data) {
              console.log(data);
              data = JSON.parse(data);
              data.guests.forEach((v, i) => {
                  $("#join").append(`
            <div class="author-time">
              <span>` + v.guestName + `</span> 来自于 <span>` + v.guestAddress + `</span>

            </div>
            <div class="news-des">
              <h3 class="news-title"><i></i><a href="#">` + v.guestTitle + `</a></h3>
              <div class="news-content-des">
                <p class="line-limit-length">
                ` + v.guestContent + `
                </p>
                  <button type="submit" style="cursor:pointer">回复</button>
              </div>
